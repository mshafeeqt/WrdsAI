...
def index_class_11_physics() -> None:
    """Build semantic FAISS indexes for Class 11 Physics PDFs only."""
    target_dir = settings.math_data_dir / "Class 11" / "Physics"
    ...
    print(
        "Class 11 Physics semantic indexing complete: "
        f"success={successes}, failed={failures}, chunks={total_chunks}"
    )


if __name__ == "__main__":
    index_class_11_physics()
